    ...
    yAxis: [
      {
        type: "category",
        inverse: true,
        data: ["其他", "医生性别", "医生年龄", "宠物医院前台推荐", "技术能力"],
        // 不显示y轴的线
        axisLine: {
          show: false
        },
...
export function abc6(){
  ...
  var XAData = [
    ...
    [{ name: "银川" }, { name: "深圳", value: 100 }],
    [{ name: "石家庄" }, { name: "深圳", value: 100 }],
    
  ];

  var XNData = [
    [{ name: "拉萨" }, { name: "拉萨", value: 100 }],
    [{ name: "上海" }, { name: "上海", value: 100 }],
    [{ name: "广州" }, { name: "广州", value: 100 }],
    [{ name: "西宁" }, { name: "西宁", value: 100 }],
    [{ name: "银川" }, { name: "银川", value: 100 }],
    [{ name: "哈尔滨" }, { name: "哈尔滨", value: 100 }],
    [{ name: "潍坊" }, { name: "潍坊", value: 100 }],
    [{ name: "西安" }, { name: "西安", value: 100 }],
    [{ name: "石家庄" }, { name: "石家庄", value: 100 }], 
  ];

  var YCData = [
    [{ name: "潍坊" }, { name: "深圳", value: 100 }],
    [{ name: "哈尔滨" }, { name: "深圳", value: 100 }],
    [{ name: "上海" }, { name: "深圳", value: 100 }],
